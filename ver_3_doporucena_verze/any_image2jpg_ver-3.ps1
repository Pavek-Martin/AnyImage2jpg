...
$pripony_obrazku = @("png", "tif", "jpeg", "pcx", "bmp", "gif", "tiff", "webp") # co chybi tak jeste doplnit
...
# vlastne by bylo lepsi kdyto to tam nebylo...
...
# pozn. asi by to slo udelat jenom z jednim polem nebyt preddefinovane funkce Get-ChildItem...
# takhle pole 2 a vnich temer to same
