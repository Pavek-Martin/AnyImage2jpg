...
$pripony_obrazku = @("png", "tif", "jpeg", "pcx", "bmp", "gif") # co chybi tak jeste doplnit
#                     ^ pozor aby nebylo 2x totez, dela to pak kraviny, dlouho jsm pak hledal chybu !!! 
$znak_rozdelovac = "."
$pripona_jpg=".jpg"
$pocitadlo = 1
...
Write-host -ForegroundColor yellow "Imagemagick for Windows, any_image2jpg (verze 2)"
...
#$smaz_source="Remove-Item -Path "+'"'+$pwd2+$file+'" -Force'
$smaz_source='"'+$pwd2+$file+'" -Force'
echo $smaz_source
